...
async function main() {
  ...
  const subcategoryDefs = [
    ...
    // ── Polki Kundan ─────────────────────────────────────────────────
    { name: "Polki Collection",slug: "polki-collection",group: "Polki Kundan",    displayOrder: 1  },
    ...
    // ── Oxidised ─────────────────────────────────────────────────────
    { name: "Oxidised Jewels", slug: "oxidised-jewels", group: "Oxidised",        displayOrder: 1  },
  ];
  ...
  const productsData = [
    ...
    // --- Mock Products for other categories ---
    {
      ...
      slug: "anti-tarnish-chain",
      categoryId: catByName["Anti Tarnish"].id,
      subcategoryId: subcatBySlug["anti-tarnish"].id,
      price: 399,
      mrp: 499,
      shortDesc: "Everyday wear anti-tarnish chain.",
      description: "<p>Waterproof and sweatproof chain for daily use.</p>",
      stockQty: 50,
      stockStatus: "IN_STOCK",
      isPublished: true,
      isBestseller: true,
    ...
    {
      name: "Polki Kundan Choker Set",
      slug: "polki-kundan-choker-set",
      categoryId: catByName["Polki Kundan"].id,
      subcategoryId: subcatBySlug["polki-collection"].id,
      price: 3499,
      mrp: 4999,
      shortDesc: "Royal polki choker with earrings.",
      description: "<p>Stunning uncut diamond look polki choker set.</p>",
      stockQty: 5,
      stockStatus: "IN_STOCK",
      isPublished: true,
      isBestseller: false,
    ...
    },
    {
      ...
      slug: "bridal-heavy-set",
      categoryId: catByName["Bridal"].id,
      subcategoryId: subcatBySlug["bridal-sets"].id,
      price: 15999,
      mrp: 20000,
      shortDesc: "Complete bridal set with matching accessories.",
      description: "<p>Everything a bride needs for her special day.</p>",
      stockQty: 2,
      stockStatus: "LOW_STOCK",
      isPublished: true,
      isBestseller: true,
    ...
    {
      name: "German Silver Long Necklace",
      slug: "german-silver-long-necklace",
      categoryId: catByName["German Silver"].id,
      subcategoryId: subcatBySlug["german-silver"].id,
      price: 1299,
      mrp: 1899,
      shortDesc: "Tribal look german silver necklace.",
      description: "<p>Boho chic long necklace.</p>",
      stockQty: 10,
      stockStatus: "IN_STOCK",
      isPublished: true,
      isBestseller: false,
    ...
    },
    {
      ...
      slug: "oxidised-jhumkas-mock",
      categoryId: catByName["Oxidised"].id,
      subcategoryId: subcatBySlug["oxidised-jewels"].id,
      price: 349,
      mrp: 499,
      shortDesc: "Trendy black metal jhumkas.",
      description: "<p>Perfect pair for ethnic kurtis.</p>",
      stockQty: 30,
      stockStatus: "IN_STOCK",
      isPublished: true,
      isBestseller: true,
