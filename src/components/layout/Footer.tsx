      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-14 pb-10 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10">
        ...
        <div>
          ...
          <div className="flex gap-3">
            ...
            <a href={`https://wa.me/${cleanWhatsAppNumber(whatsappNumber)}`} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full flex items-center justify-center" style={{ background: "#25d366" }} aria-label="WhatsApp">
